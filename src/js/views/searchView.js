...
const renderButtons = (page, numResults, resPerPage) => {
    // calculates how many total pages for example if 
    // there is 30 results and 10 PerPage, then there will be 3 pages
    const pages = Math.ceil(numResults / resPerPage);
    let button;
    
    // what button available for next page
    if (page === 1 && pages > 1) {
...
// this function calculates how many result will show
